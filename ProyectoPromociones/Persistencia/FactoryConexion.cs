...
namespace ProyectoPromociones.Persistencia
{
    public class FactoryConexion
    {
        ...
        public static string CreateConnection()
        {
            ...
            {
                if (ConfigurationManager.ConnectionStrings[i].Name.Equals("ProyectoPromociones.Properties.Settings.sql", StringComparison.InvariantCultureIgnoreCase))
                    existe = true;
            }
            ...
            conexion.AppendFormat("{0}", ConfigurationManager.ConnectionStrings["ProyectoPromociones.Properties.Settings.sql"].ConnectionString);
