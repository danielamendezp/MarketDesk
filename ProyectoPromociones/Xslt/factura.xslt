	...
	<xsl:template match="/MarketDesk">
		<html>
			...
			<body>
				...
				<h2>Detalles Financieros Colones</h2>
				<table>
					<tr>
						<th>Subtotal</th>
						<th>Impuestos</th>
				...
				<h2>Detalles Financieros USD</h2>
				<table>
					<tr>
						<th>SubtotalUSD</th>
						<th>ImpuestosUSD</th>
					...
					<tr>
						<td>
							<xsl:value-of select="Productos/SubTotalUSD"/>
						</td>
						<td>
							<xsl:value-of select="Productos/ImpuestosUSD"/>
						</td>
						<td>
							<xsl:value-of select="Productos/DescuentosUSD"/>
						</td>
						<td>
							<xsl:value-of select="Productos/TotalUSD"/>
						</td>
					</tr>
				</table>
			</body>
